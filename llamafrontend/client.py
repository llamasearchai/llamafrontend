"""
Client module for llamafrontend.
"""
...
class Client:
    """Main client for interacting with the llamafrontend API."""
    ...
    def __init__(self, api_key=None, base_url=None, config=None):
        ...
        self.base_url = base_url or "https://api.llamasearch.ai/llamafrontend"
