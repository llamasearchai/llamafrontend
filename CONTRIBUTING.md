# Contributing to LlamaFrontend

Thank you for your interest in contributing to LlamaFrontend! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaFrontend:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamafrontend.git
   cd llamafrontend
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamafrontend.git
   ```
...
By contributing to LlamaFrontend, you agree that your contributions will be licensed under the project's MIT License.
